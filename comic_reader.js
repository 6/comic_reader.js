...
(function() {
  var ComicMetaView, ComicPage, ComicPages,
  ...
  ComicPages = (function(_super) {
    ...
    ComicPages.prototype.initialize = function() {
    ...
    ComicPages.prototype.fetched = function() {
      var _this = this;
    ...
    ComicPages.prototype.percentFetched = function() {
      return Math.round(this.fetched().length / this.size() * 100);
    };

    ComicPages.prototype.setCurrentPage = function(pageIndex) {
  ...
  this.ComicReader = (function(_super) {
    ...
    ComicReader.prototype.showPage = function(pageIndex) {
      ...
      this.$el.find(".comic-image-wrap").hide(0).html("<img class='comic-image' src='" + (page.get('url')) + "'>").fadeIn(30);
